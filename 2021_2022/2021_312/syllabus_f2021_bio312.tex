...
% Week 12
\caltext{11/8/21}{\textbf{Topic:} Succession}
\caltext{11/8/21}{\color{teal} \emph{Reading Quiz: Community 1-2} \color{black}}

\caltext{11/9/21}{\textbf{Lab:} Open Lab}
%\caltext{11/9/21}{\color{blue} \emph{Due: Lightning Talk Slides} \color{black}}

\caltext{11/10/21}{\textbf{Topic:} Competition}
\caltext{11/10/21}{\color{teal} \emph{Reading Quiz: Competition 1} \color{black}}

\caltext{11/12/21}{\textbf{Topic:} Competition}
\caltext{11/12/21}{\color{teal} \emph{Reading Quiz: Competition 2} \color{black}}

% Week 13
\caltext{11/15/21}{\textbf{Topic:} Competition}
\caltext{11/15/21}{\color{teal} \emph{Reading Quiz: Competition 3} \color{black}}
...
\caltext{11/17/21}{\color{teal} \emph{Reading Quiz: Keystone Predator}\color{black}}
