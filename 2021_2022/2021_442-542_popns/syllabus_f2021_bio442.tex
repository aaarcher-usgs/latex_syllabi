...
\caltext{10/5/21}{\color{blue} \emph{Lab: } Closed mark-recapture \color{black}}


\caltext{10/7/21}{\textbf{Topic:} Population estimation}
\caltext{10/7/21}{\color{blue} \emph{Lab: Open mark-recapture CJS} \color{black}}


% Week 8
\caltext{10/12/21}{\textbf{Topic:} Population estimation }
\caltext{10/12/21}{\color{blue} \emph{Lab: Double observer surveys} \color{black}}


\caltext{10/14/21}{\textbf{Topic:} Population estimation}
\caltext{10/14/21}{\color{blue} \emph{Lab: Review} \color{black}}
