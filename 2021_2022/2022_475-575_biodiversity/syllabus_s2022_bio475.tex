...
\caltext{1/26/22}{\textbf{Topic:} R-Markdown/R-Oxygen}
...
\caltext{2/2/22}{{Data Sources}}
\caltext{2/2/22}{\color{teal} \emph{Bioinformatics Data Skills Ch 6} \color{black}}
\caltext{1/31/22}{\color{blue} \emph{Bonus Lab: Working with knitr \\ due on GitHub at 10pm} \color{black}}


% Week 5
\caltext{2/9/22}{\textbf{Data Source Presentations}}
