...
% Week 16
%\caltext{12/6/21}{}
\caltext{12/6/21}{\emph{No class}}

\caltext{12/7/21}{\textbf{Topic:} Island Biogeography, Review}
%\caltext{12/7/21}{\color{blue} \emph{Due: Lightning Talk Slides} \color{black}}
\caltext{12/7/21}{\color{teal} \emph{Reading Quiz: Biogeography 2} \color{black}}
\caltext{12/8/21}{\emph{No class}}
\caltext{12/10/21}{\emph{No class}}
