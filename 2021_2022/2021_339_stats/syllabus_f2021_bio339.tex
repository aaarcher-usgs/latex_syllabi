...
\newthought{{Final Exam:}} There is one D2L exam at the end of the semester that will cover material from the entire course and will be similar to the problems given in the assignments. Exams are timed, and cannot be taken more than once. Exams must be completed by yourself.
