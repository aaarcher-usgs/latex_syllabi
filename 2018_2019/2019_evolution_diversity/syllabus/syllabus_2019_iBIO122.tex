...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Week 1
\caltext{1/11/19}{Watch Judgement Day video. Screening times:
\begin{itemize}
\item 8-10am 
\item 10:30-12:30
\item 12:30-2:30
...
\caltext{1/14/19}{Activity: Guppy Spots}
\caltext{1/14/19}{
	\begin{itemize}
	\item Bring laptop/tablet
	\item Print/Bring: ``Guppy Spots'' 
...
\caltext{1/16/19}{Activity: Guppy Spots }
\caltext{1/16/19}{
	\begin{itemize}
	\item Bring laptop/tablet
	\item Finish: ``Guppy Spots''
	\end{itemize}
}
...
\caltext{1/18/19}{Notebook Check:
	\begin{itemize}
	\item ``Judgement Day''
	\item ``Guppy Spots - Comparing Literature''
	\item ``Guppy Spots - Experimental Planning''
	\end{itemize}
}
...
\caltext{1/28/19}{Guppy Paper Due on Moodle}
