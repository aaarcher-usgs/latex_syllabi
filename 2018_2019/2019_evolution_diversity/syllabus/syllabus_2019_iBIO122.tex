...
\newthought{{Participation, Prelabs \& Assignments}} includes in-class participation and exercises, MasteringBiology assignments, pre-labs to be filled out before class, lecture and lab notes, and occasional homework assignments. MasteringBiology will be used to provide reading quizzes that will be due on most Fridays by 11:59pm. 
...
\newthought{Open Lab Hours:} will be held in ISC 256 every Friday from 9:15-10:30am and 12:00-4:30pm.
...
\caltext{2/13/19}{%Lab Material:
	\begin{itemize}
	\item Pre-lab Due: Annelida \& Mullusca
