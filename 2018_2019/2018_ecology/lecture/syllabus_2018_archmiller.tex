...
\newthought{SimUText Readings} are from the interactive textbook for this class, and each module has integrated, feedback-focused questions followed by a series of graded questions. \textbf{SimUText readings are due by 8:00am on the due date (see schedule).} 
...
\begin{itemize}
	\item SimUText Sections: You are expected to come to class prepared by reading that lecture's associated SimUText Module. SimUText assignments are due at 8am unless otherwise noted. There will be quizzes on reading material at the beginning of lecture.
...
\caltext{9/3/18}{\textbf{SimUText:} Evolution for Ecology 1-3, Biogeography 3}
...
\caltext{9/12/18}{\textbf{SimUText:} Biogeography 4, Physiological Ecology 1}
\caltext{9/14/18}{\textbf{GD:} The Serengeti Rules p47--105 (by 5pm) }
\caltext{9/14/18}{\textbf{Library Materials assignment due} on Lab Moodle page by 11:59pm}

% Week 3
\caltext{9/17/18}{\textbf{SimUText:} Physiological Ecology 2-4}
\caltext{9/19/18}{\textbf{Symposium} \\ No office hours}

% Week 4
\caltext{9/24/18}{\textbf{SimUText:} Ecosystem Ecology 1-3}
...
% Week 5
\caltext{10/1/18}{\textbf{SimUText:} Climate Change 1-5}
...
% Week 7
\caltext{10/15/18}{\textbf{SimUText:} Nutrient Cycling 1-4}
...
% Week 9
\caltext{10/29/18}{\textbf{SimUText:} Life History 1-4}
\caltext{11/2/18}{\textbf{GD:}  Omnivore's Dilemma p65-99, p410-411 (5pm) }

% Week 10

\caltext{11/5/18}{\textbf{SimUText:} Population Growth 1-3}
\caltext{11/5/18}{\textbf{In Class:} Understanding Population Growth Models}
\caltext{11/7/18}{\textbf{SimUText:} Population Growth 4-5}
...
% Week 12
\caltext{11/19/18}{\textbf{SimUText:} Biogeography 1-2}
...
% Week 13
\caltext{11/26/18}{\textbf{SimUText:} Community Dynamics 1-2}
\caltext{11/28/18}{\textbf{SimUText:} Community Dynamics 3-5}
\caltext{11/30/18}{\textbf{GD:}  Sand County Almanac p95-112; 129--137; 165--176 (by 5pm) }

% Week 14
\caltext{12/3/18}{\textbf{SimUText:} Competition 1-2}
\caltext{12/5/18}{\textbf{SimUText:} Competition 3-4}
\caltext{12/7/18}{\textbf{GD:} Sand County Almanac p188--226 (by 5pm) }

% Week 15
\caltext{12/10/18}{\textbf{SimUText:} Predation, Herbivory and Parasitism 1-2}
\caltext{12/12/18}{\textbf{SimUText:} Predation, Herbivory and Parasitism 3-4}
