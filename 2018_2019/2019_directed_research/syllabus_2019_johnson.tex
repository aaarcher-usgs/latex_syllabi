...
The format of this class will be a collaborative and iterative writing format. Your responsibility will be to have new material (at least 100 new words, or at least 200 edited words) prepared in the manuscript by every Tuesday at 11pm. My responsibility will then be to have read, commented on, and/or edited the new material by Thursday at 11pm. This collaborative writing will be managed through the RStudio/GitHub reproducible framework. 

By the end of the semester, I expect you to have accomplished the following:

\begin{itemize}
	\item Read one relevant article per week and summarize its main points in the annotated bibliography
	\item Draft the introduction, methods, results, and discussion of our research manuscript in JWM format.
\end{itemize}
