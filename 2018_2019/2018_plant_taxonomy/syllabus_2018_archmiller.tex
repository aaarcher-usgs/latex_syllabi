...
\begin{enumerate}
	...
	\item Experience 24+ hours of outdoor learning in various climates and ecosystems
\end{enumerate}
...
\begin{itemize}
	...
	\item Dedicated field notebook such as Rite in the Rain or Moleskin. I recommend one with numbered pages and blank or faint horizontal lines. Sketchbooks also work well.
...
\begin{itemize}
	...
	\item Also, this course counts as a ``field course,'' which means that you must be present in class for at least 24 hours of outdoor field labs (travel to and from field sites does not count). \textbf{It's important for you to dress appropriately for the weather for all lab sessions.}
