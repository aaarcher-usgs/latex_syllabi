...
\caltext{2/12/20}{No class- blizzard day!}
...
\caltext{2/14/20}{%Lab Material:
	\begin{itemize}
	\item Pre-lab Due: Mollusca
	\end{itemize}
}
...
\caltext{2/17/20}{Topic: Lophotrochozoa} % Lecture/Lab 2
\caltext{2/17/20}{Campbell Biology: Ch 33\dotfill}
\caltext{2/17/20}{Activity: Mollusca}
\caltext{2/17/20}{Notebook Check:
	\begin{itemize}
	\item ``Platyhelminthes''
	\end{itemize}
	}

\caltext{2/19/20}{Topic: Annelida, Ecdysozoa: Nematoda} % Lecture/Lab 2
\caltext{2/19/20}{Campbell Biology: Ch 33\dotfill}
\caltext{2/19/20}{Activity: Annelida \& Nematoda}
...
\caltext{2/24/20}{Activity: Echinodermata \& Arthropoda}
\caltext{2/24/20}{%Lab Material:
	\begin{itemize}
	\item Pre-lab Due: Echinodermata
	\end{itemize}
}
\caltext{2/24/20}{Notebook Check:
	\begin{itemize}
	\item ``Nematoda'' 
	\item ``Annelida''
